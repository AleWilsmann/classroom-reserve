...
@section('content')
    ...
    <div class="container">
        <div class="card">
            ...
            <p class="subtitle">Vincule uma sala a um responsável e agende o horário.</p>
                ...
                <div class="form-group">
                    ...
                    <select id="responsible_id" name="responsible_id" required>
                        ...
                        @foreach($responsibles as $responsible)
                            <option value="{{ $responsible->id }}" {{ old('responsible_id') == $responsible->id ? 'selected' : '' }}>{{ $responsible->name }} — {{ $responsible->email }}</option>
                        @endforeach
                    </select>
                </div>
