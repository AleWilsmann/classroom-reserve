...
@section('content')
    ...
    <title>Criar Novo Responsável — Educar Mais</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="card">
            <h1 class="title">Novo Responsável</h1>
            <p class="subtitle">Preencha os dados para cadastrar um novo responsável</p>
            ...
            <form method="POST" action="{{ route('responsibles.store') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        required
                    />
                    <p class="help-text">Deve ser um email único no sistema</p>
                </div>
